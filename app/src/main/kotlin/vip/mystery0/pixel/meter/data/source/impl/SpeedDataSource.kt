...
class SpeedDataSource(
    ...
    override suspend fun getTrafficData(): NetworkTrafficData? = withContext(Dispatchers.IO) {
        ...
        for (network in allNetworks) {
            ...
            // 核心过滤逻辑�?
            // 我们只关心物理接�?(Wi-Fi, 蜂窝, 以太�?
            // 显式忽略 TRANSPORT_VPN，这样就彻底避开�?tun0 等虚拟接口的重复计数
